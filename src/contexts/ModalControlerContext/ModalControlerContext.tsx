...
export default function ModalControlerProvider ({children}: ModalControlerProps){
...
export function useModalControler (): ModalControlerContextType {
    ...
    if(!context){
        throw new Error("useModalControler deve ser usado dentro de um ModalControlerProvider")
    }
